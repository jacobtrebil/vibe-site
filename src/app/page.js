  ...
  return (
    <main className="main">
      <script
        async
        data-uid="c007bbef55"
        src="https://fresh-3.kit.com/c007bbef55/index.js"
      ></script>
      <div>
        <div className="headlineDiv">
          <h1
            className={`${spacemono.className} vibeHeadline`} /*"rubik vibeHeadline"*/
          >
            Vibe
          </h1>
        </div>
        ...
        <div className="mainDiv">
          <div className="buttonDiv">
            <h2 className={`${spacemono.className} headline`}>
              <span className="colorfulText">
                A Necklace That Tracks Your Nutrition
              </span>
            </h2>
            <button
              className={`${spacemono.className} neon-button`}
              data-formkit-toggle="c007bbef55"
              src="https://fresh-3.kit.com/c007bbef55/index.js"
            >
              Join Waitlist →
            </button>
